...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation)
        ...
        while (metaObject.hasGetter("h")) {
            ...
            metaObject = MetaObject.forObject(object, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY,DEFAULT_REFLECTOR_FACTORY);
        }
        // 分离最后一个代理对象的目标类
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement, BoundSql boundSql, Page page, MetaObject metaObject) {
        // 获取总记录数
        // TODO: 2017/6/28 0028 mengLei 修改sql获取总数：去掉 order by
        String countSql;
        ...
        try {
            ...
            // 解决foreach参数失效问题 add by mengLei 20170315
